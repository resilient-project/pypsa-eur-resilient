...
def _map_lines_to_buses(n, lines, regions_onshore):
...
def _drop_redundant_lines(lines):
    logger.info("Dropping internal lines or lines with missing endpoints.")
...
if __name__ == "__main__":
    ...
    lines_electricity_transmission = _map_lines_to_buses(
        n, components["lines_electricity_transmission"], regions_onshore
    )
    lines_electricity_transmission = _drop_redundant_lines(
