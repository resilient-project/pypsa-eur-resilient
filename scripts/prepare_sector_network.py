...
def add_co2_tracking(n, costs, spatial, options, sequestration_potential_file=None):
    """
...
if __name__ == "__main__":
    ...
    if pci_pmi_projects.get("enable", False):
        add_co2_tracking(n, costs, spatial_pci_pmi, options, sequestration_potential_file=snakemake.input.sequestration_potential)
